...
`upr_bound` is a numeric vector, showing just the uppoer bounds of the prediction interval. +/- upr_bound values capture 95% of actual error. Or put another way, FoldX ddG +/- upr_bound would contain the true (experimental) ddG.
